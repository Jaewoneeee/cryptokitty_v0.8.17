...
contract ClockAuctionBase is ERC721Holder {
    ...
    /// @dev DON'T give me your money. 이기 때문에 payable타입의 receive XX
    fallback() external {}
        ...
        returns (uint256)
    {
        ...
        require(_bidAmount >= price, "_bidAmount should be greater than or eqaul to auction's current price");
